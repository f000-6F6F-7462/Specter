...
from specter.api.dependencies import MessageBusDependency
...
async def read_health(message_bus: MessageBusDependency, response: Response) -> HealthResponse:
    ...
    """
    is_nats_connected = message_bus.is_connected
